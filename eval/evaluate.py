...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_dir', type=str, default="../results/results_test/TUT_results",
                        help='Directory containing prediction and ground truth images')
